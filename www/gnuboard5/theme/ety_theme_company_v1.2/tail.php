...
<?php }?>
		...
		<div class="container footer">
			<div class="row">
				<div class="col-md-3 text-white text-left">
					<h2>라켓디자인</h2><!-- image or text  -->
					<p>
					무료테마배포 <a href="http://ringoberry.cafe24.com/1/" target="_blank">샘플테마</a>
					</p>
					<p class="text-center">
						<div class="sns_icon">
	...
	<div class="container-fluid bg-gray">
		<div class="col-md-12 text-white text-center">
				Copyright 2020 &copy; <a href="http://ringoberry.cafe24.com/1/" target="_blank">HTTP://ringoberry.cafe24.com/1/</a>
		</div>
	</div><!-- /container -->
