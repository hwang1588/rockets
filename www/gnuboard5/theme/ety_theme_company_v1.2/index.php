	...
	<div class="carousel-inner" role="listbox">
	  ...
	  <div class="carousel-item active" style="background-image: url('<?php echo G5_THEME_URL?>/img/background02.jpg')">
		<div class="carousel-caption d-none d-md-block">
		  <h3 class="ko1">라켓디자인 홈페이지</h3>
		  <p class="ko1 f20">사이트 제작 전문 라켓디자인 홈페이지에 어서오세요</p>
		</div>
	  </div>
	  ...
	  <div class="carousel-item" style="background-image: url('<?php echo G5_THEME_URL?>/img/background05.jpg')">
		<div class="carousel-caption d-none d-md-block">
		  ...
		  <p class="ko1 f20">사이트 제작을 전문으로 하는 라켓디자인 입니다</p>
		</div>
	  </div>
	  <!-- Slide Three - Set the background image for this slide in the line below -->
	  <div class="carousel-item" style="background-image: url('<?php echo G5_THEME_URL?>/img/background01.jpg')">
		<div class="carousel-caption d-none d-md-block">
		  <h3 class="ko1">크몽에서 서비스 확인</h3>
		  <p class="ko1 f20">현재 서비스중인 상품을 크몽에서도 확인 가능합니다</p>
		</div>
	  </div>
	</div>
...
<div class="container">
	<div class="center-heading">
		...
		무료로 사용가능한 반응형 테마는 커뮤니티 테마, 비즈니스 테마로 구분 됩니다.
		</p>
	</div>
	<div class="row">
				...
				<div class="icon">
					...
					<div class="info">
						...
						<div class="margin-top-20 margin-bottom-20">
							<button type="button" class="btn btn-secondary btn-sm" onclick="location.href='http://http://ringoberry.cafe24.com/1/'">바로가기</button>
						</div>
					</div>
				</div>
				<div class="space"></div>
			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
						...
						<div class="margin-top-20 margin-bottom-20">
							<button type="button" class="btn btn-secondary btn-sm" onclick="location.href='http://ringoberry.cafe24.com/1/'">바로가기</button>
						</div>
					</div>
				</div>
				<div class="space"></div>
			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
						...
						<p class="ko1 f15">
							현재 라켓디자인 에서 배포중인 무료 비즈니스 반응형 홈페이지의 경우 질문답변 게시판에서 서포트를 해드리고 있습니다. 문의사항은 질문게시판에 글 남겨주세요.
						</p>
						<div class="margin-top-20 margin-bottom-20">
							<button type="button" class="btn btn-secondary btn-sm" onclick="location.href='http://ringoberry.cafe24.com/1/'">바로가기</button>
						</div>
	...
	<div class="container">
	  ...
	  <div class="row margin-top-50 margin-bottom-50">
		...
		<div class="col-lg-5">
		  ...
		  <p class="ko_16">
		  현제 제작되는 모든 테마 및 템플릿은 글로벌하게 <strong><a href="http://ringoberry.cafe24.com/1/" target="_blank">라켓디자인</a></strong> 에서 제작되고 있으며 무료 테마 및 템플릿의 경우에는 이미지가 포함 되어 있지 않습니다. 또한 <strong><a href="http://ringoberry.cafe24.com/1/" target="_blank">라켓디자인</a></strong>로 오시면 추가적인 업데이트된 파일을 다운로드 하실 수 있습니다.</p>
		</div>
		<div class="col-lg-7">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center p-center para-text">
				<h2 class='text-light'>반응형 커뮤니티 , 반응형 비즈니스 라켓디자인 바로가기</h2>
				<button type="button" class="btn btn-outline-light" onclick='window.open("about:blank").location.href="http://ringoberry.cafe24.com/1/"'>바로가기</button>
			</div>
		</div>
	</div>
</div><!-- /parallax -->
...
<div class="callbox">
	...
	<h3 class="margin-bottom-50 text-left ko1">DEMO</h3>
	  <div class="row">
		<div class="col-md-8">
		  <p class="ko_17">
		  라켓디자인에 대한 궁금증이나 질문이 있으시면 라켓디자인의 질문게시판을 이용해주세요.<BR />
		  http://ringoberry.cafe24.com/1/
		  </p>
		</div>
		<div class="col-md-4">
		  <a class="btn btn-lg btn-secondary btn-block" href="http://ringoberry.cafe24.com/1/" target="_blank">GO!</a>
		</div>
	  </div>
	</div>
</div>
