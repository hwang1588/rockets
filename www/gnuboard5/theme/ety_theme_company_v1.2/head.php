...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	  <!--<div class="navbar-brand" style="background-image: url('<?php echo G5_THEME_URL?>/img/logo_mini.png'); width:18%; height: 10%; padding:57px 0px 0px 0px;"></div>-->
	<a href="<?php echo G5_URL?>">
	<div class="navbar-brand" style="background-image: url('<?php echo G5_THEME_URL?>/img/logo_mini.png'); padding:35px 70px 0px 50px; margin-top:6px;"></div>
	</a> 
