...
<div id="hd">
   ...
   <div class="container"><div class="row"><div class="span12">
	<div class="header_inner clearfix">
		<div class="top1"><a href="<?php echo G5_URL ?>" class="logo">라 켓 디 자 인<span> (ver.3.2)</span></a></div>
		<div class="top2">
			<div class="menu_top">
		        <ul id="menu_top" class="clearfix">
                <li><a href="<?php echo G5_BBS_URL ?>/faq.php"><span>FAQ</span></a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/qalist.php"><span>1:1문의</span></a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php" class="visit"><span>접속자</span><strong class="visit-num"><?php echo connect('theme/basic'); ?></strong></a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/new.php"><span>새글</span></a></li>          
		        </ul>
			</div>
		</div>
	</div>
        ...
        <div class="gnb_wrap">
            <ul id="gnb_1dul">
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++) 
				{
                    ...
                    for ($k=0; $row2=sql_fetch_array($result2); $k++) { $menu_datas[$i]['sub'][$k] = $row2; }
                }
                $i = 0; foreach( $menu_datas as $row ){ if( empty($row) ) continue; 
                ?>
